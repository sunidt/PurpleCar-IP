...
--
-- Host: localhost
-- Generation Time: Apr 06, 2023 at 04:58 AM
...
(10, 'ณวิทย์ มิสาโท่', 'Male', '1981-03-21', 'Nawit', 'Nawit123', '0845678812', '29845628');
...
(26, 1, 9, 1, 'จง-4455', '2023-03-04', '0640', 18),
(28, 1, 1, 1, 'กก-1111', '2023-03-11', '0640', 15),
(29, 2, 9, 2, 'ขข-2222', '2023-03-11', '0700', 18),
(30, 1, 9, 3, 'คค-3333', '2023-03-11', '0640', 18),
(31, 2, 1, 4, 'งง-4444', '2023-03-11', '0700', 12),
(32, 1, 1, 5, 'มม-9991', '2023-03-11', '0805', 18),
(33, 1, 9, 1, 'ขก-5544', '2023-03-11', '0805', 18),
(34, 2, 1, 2, 'สส-7777', '2023-03-11', '0825', 18),
(35, 2, 9, 7, 'วว-9637', '2023-03-11', '0825', 18),
(38, 1, 1, 1, 'จง-4444', '2023-03-12', '0640', 18),
(39, 1, 9, 2, 'ขก-5544', '2023-03-12', '0640', 18),
(40, 2, 1, 5, 'มม-9991', '2023-03-12', '0700', 18),
(41, 2, 9, 10, 'วว-9637', '2023-03-12', '0700', 18),
(42, 1, 1, 5, 'จง-4444', '2023-04-04', '0640', 18),
(43, 1, 1, 5, 'จง-4444', '2023-04-04', '0640', 2),
(44, 1, 9, 7, 'สส-7777', '2023-04-10', '0640', 8),
(45, 2, 9, 6, 'สว-7877', '2023-04-10', '0700', 18);
...
(63312162, 'ธีระศักดิ์ เพียรลุกิจ', 'Male', '2001-10-13', 'Teerasak_not', 'Teerasak1234', '0993334445', 25),
...
(63315125, 'สุวิชาดา พรมมา', 'Female', '2002-01-05', 'Suwichada_mew', 'Suwichada1234', '0992223334', 53),
(63315126, 'มิว', 'Female', '2002-02-02', 'mew', '12345678', '0900000000', 100),
(63315128, 'โอบอ้อม', 'Female', '2001-11-12', 'AA', '12112544', '0901234567', 4932),
...
CREATE TABLE `reserve` (
  ...
  `receipt` varchar(300) NOT NULL COMMENT 'ใบเสร็จ'
...
INSERT INTO `reserve` (`Passenger_ID`, `Ticket_ID`, `bookDate`, `receipt`) VALUES
(63315128, 0, '2023-04-04', ''),
...
(63315125, 13, '2023-03-10', ''),
(63314975, 15, '2023-03-08', ''),
(63315125, 13023, '2023-03-10', ''),
(63315128, 13059, '2023-04-04', 'images.jpg'),
(63315128, 13061, '2023-04-04', 'cat_279.jpg'),
(63315128, 13074, '2023-04-04', 'img/points.png'),
(63315128, 13075, '2023-04-04', 'img/points.png'),
(63315128, 13076, '2023-04-04', 'img/points.png'),
(63315128, 13085, '2023-04-04', '322868_1100-800x825.jpg'),
(63315128, 13086, '2023-04-04', '322868_1100-800x825.jpg'),
(63315128, 13087, '2023-04-04', 'img/points.png'),
(63315128, 13088, '2023-04-04', 'img/points.png'),
(63315128, 13089, '2023-04-04', 'img/points.png'),
(63315128, 13090, '2023-04-04', 'img/points.png'),
(63315128, 13091, '2023-04-04', 'img/points.png'),
(63315128, 13092, '2023-04-04', 'images.jpg'),
(63315128, 13093, '2023-04-04', 'images.jpg'),
(63315128, 13098, '2023-04-05', '13099.jpg'),
(63315128, 13099, '2023-04-05', '13099.jpg'),
(63315128, 13102, '2023-04-05', 'points.png'),
(63315128, 13103, '2023-04-05', 'points.png'),
(63315128, 13104, '2023-04-05', '13105.jpg'),
(63315128, 13105, '2023-04-05', '13105.jpg');
...
--
ALTER TABLE `driving_cycle`
  MODIFY `driving_cycle_id` int(12) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรอบรถ', AUTO_INCREMENT=46;
...
--
ALTER TABLE `ticket`
  MODIFY `Ticket_ID` int(14) NOT NULL AUTO_INCREMENT COMMENT 'รหัสตั๋ว', AUTO_INCREMENT=13106;
