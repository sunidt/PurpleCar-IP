...
--
-- Host: localhost
-- Generation Time: Feb 23, 2023 at 04:25 PM
...
CREATE TABLE `departure_time` (
  ...
  `time` time(4) NOT NULL COMMENT 'เวลา',
...
INSERT INTO `departure_time` (`time_id`, `time`, `route_b_r`, `start_NU_TC`) VALUES
('0640', '06:40:00.0000', '10', '11'),
('0700', '07:00:00.0000', '01', '11'),
('0805', '08:05:00.0000', '10', '11'),
('0825', '08:25:00.0000', '01', '11'),
('0900', '09:00:00.0000', '10', '11'),
('0925', '09:25:00.0000', '01', '11'),
('1025', '10:25:00.0000', '10', '11'),
('1035', '10:35:00.0000', '01', '11'),
('1150', '11:50:00.0000', '10', '11'),
('1220', '12:20:00.0000', '01', '11'),
('1315', '13:15:00.0000', '10', '11'),
('1335', '13:35:00.0000', '01', '11'),
('1440', '14:40:00.0000', '10', '11'),
('1500', '15:00:00.0000', '01', '11'),
('1605', '16:05:00.0000', '10', '11'),
('1625', '16:25:00.0000', '01', '11'),
('1730', '17:30:00.0000', '10', '11');
...
(2, 1, 1, 1, '1234567', '2023-02-14', '0640', 18),
(3, 2, 9, 2, 'คง-2222', '2023-02-11', '1335', 17),
(4, 1, 1, 1, 'กข-1111', '2023-02-11', '1730', 17),
...
(11, 2, 9, 9, 'อฮ-9999', '2023-02-17', '1220', 17),
(12, 2, 1, 10, 'ทน-0000', '2023-02-20', '1220', 17);
...
ALTER TABLE `ticket`
  ...
  ADD KEY `ticket_ibfk_1` (`Driving_cycle_ID`);
...
--
ALTER TABLE `driver`
  MODIFY `Driver_ID` int(4) NOT NULL AUTO_INCREMENT COMMENT 'รหัสคนขับรถ', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `driving_cycle`
--
ALTER TABLE `driving_cycle`
  MODIFY `driving_cycle_id` int(12) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรอบรถ', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `parking_spot`
--
ALTER TABLE `parking_spot`
  MODIFY `car_reservation_code` int(3) NOT NULL AUTO_INCREMENT COMMENT 'รหัสจุดจอดรถ', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `passenger`
--
ALTER TABLE `passenger`
  MODIFY `Passenger_ID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้โดยสาร', AUTO_INCREMENT=63315128;

--
-- AUTO_INCREMENT for table `route_car`
--
ALTER TABLE `route_car`
  MODIFY `car_route_id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสายรถ', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ticket`
--
ALTER TABLE `ticket`
  MODIFY `Ticket_ID` int(14) NOT NULL AUTO_INCREMENT COMMENT 'รหัสตั๋ว', AUTO_INCREMENT=14;
...
ALTER TABLE `driving_cycle`
  ...
  ADD CONSTRAINT `driving_cycle_ibfk_4` FOREIGN KEY (`time_id`) REFERENCES `departure_time` (`time_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
ALTER TABLE `ticket`
  ADD CONSTRAINT `ticket_ibfk_1` FOREIGN KEY (`Driving_cycle_ID`) REFERENCES `driving_cycle` (`driving_cycle_id`) ON UPDATE CASCADE,
